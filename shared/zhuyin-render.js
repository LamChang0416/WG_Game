...
function renderZhuyinText(pairs, options) {
  ...
  function renderColumn(parsed) {
    ...
    if (light) rows.push('<span style="display:block;line-height:1;font-size:'+(Math.round(zySize*0.6*100)/100)+'px;font-weight:800;transform:translateY(60%);margin-bottom:-0.5em;">'+esc(LIGHT_TONE)+'</span>');
